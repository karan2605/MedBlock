...
class PersonalDataWorker extends Component {
                        ...
                        <div className="p-4 p-lg-5 bg-light rounded-3 flex-fill">
                            <h1 className="display-5 fw-bold justify-content-center">Personal Data</h1>
                                <Form>
                                    ...
                                    <Form.Group className="mb-3" controlId="formUniqueId">
                                        <Form.Label>NHS Staff Number:</Form.Label>
                                        <Form.Control type="text" value={this.props.data.nhsNumber} name="Id" disabled/>
                                    </Form.Group>
                                    <fieldset disabled={(this.state.disabled) ? "disabled" : ""}>
                                        ...
                                        <Form.Group className="mb-3" controlId="formBasicLastName">
                                            ...
                                            <Form.Control type="text" value={this.props.data.placeOfWork.value} name="lname" />
                                        </Form.Group>

                                        <Form.Group className="mb-3" controlId="formBasicLastName">
                                            <Form.Label>Role:</Form.Label>
                                            <Form.Control type="text" value={this.props.data.role.value} name="lname" />
                                        </Form.Group>
                                    </fieldset>
...
export default PersonalDataWorker;